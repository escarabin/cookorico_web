System.register(['@angular/core', '@angular/forms', '@angular/common', './../shared/shared.module', './profile.routes', './components/profile.component', 'ng2-img-cropper', 'ng2-file-upload/ng2-file-upload', './../shared/components/business-select.component', './components/profile-preview.component', './components/experiences.component', './components/create-experience.component', './components/applications.component', './components/education.component', './components/create-study.component', './components/profile-sidebar.component', './components/alerts.component', './components/create-alert.component', './components/testimonials.component', './components/businesses.component', './components/create-business.component', './components/my-job-posts.component', './components/create-job-post.component', './components/applicants.component', './components/mail-templates.component', './components/create-mail-template.component', './components/website-editor.component', "./components/confirm-account-creation.component", './../shared/components/sign-up-steps.component', './components/matching-profiles.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, forms_1, common_1, shared_module_1, profile_routes_1, profile_component_1, ng2_img_cropper_1, ng2_file_upload_1, business_select_component_1, profile_preview_component_1, experiences_component_1, create_experience_component_1, applications_component_1, education_component_1, create_study_component_1, profile_sidebar_component_1, alerts_component_1, create_alert_component_1, testimonials_component_1, businesses_component_1, create_business_component_1, my_job_posts_component_1, create_job_post_component_1, applicants_component_1, mail_templates_component_1, create_mail_template_component_1, website_editor_component_1, confirm_account_creation_component_1, sign_up_steps_component_1, matching_profiles_component_1;
    var ProfileModule;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (sign_up_steps_component_1_1) {
                sign_up_steps_component_1 = sign_up_steps_component_1_1;
            },
                ...
                ProfileModule = __decorate([
                    core_1.NgModule({
                        declarations: [profile_component_1.ProfileComponent,
                            ...
                            website_editor_component_1.WebsiteEditorComponent,
                            ng2_img_cropper_1.ImageCropperComponent,
                            create_business_component_1.CreateBusinessComponent,
                            sign_up_steps_component_1.SignUpStepsComponent,
                            matching_profiles_component_1.MatchingProfilesComponent,
                            confirm_account_creation_component_1.ConfirmAccountCreationComponent],
