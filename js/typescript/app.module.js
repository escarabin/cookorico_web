System.register(['@angular/core', '@angular/platform-browser', '@angular/forms', '@angular/http', './components/app.component', './app.routes', './components/home.component', './components/footer.component', './components/notification.component', './components/header.component', './components/business-select.component', './components/tiny-mce.component', './components/sign-in.component', './components/job-search-bar.component', './components/job-preview.component', './components/post-preview.component', './components/job-search-sidebar.component', './components/new-application-form.component', './components/custom-pagination.component', './components/user-sidebar.component', './components/right-sidebar.component', './components/job.component', 'ng2-pagination', 'ng2-img-cropper', 'angular2-google-map-auto-complete/directives/googleplace.directive', 'ng2-file-upload/ng2-file-upload', 'ng2-bootstrap/ng2-bootstrap', 'angular2-google-maps/core/index'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, platform_browser_1, forms_1, http_1, app_component_1, app_routes_1, home_component_1, footer_component_1, notification_component_1, header_component_1, business_select_component_1, tiny_mce_component_1, sign_in_component_1, job_search_bar_component_1, job_preview_component_1, post_preview_component_1, job_search_sidebar_component_1, new_application_form_component_1, custom_pagination_component_1, user_sidebar_component_1, right_sidebar_component_1, job_component_1, ng2_pagination_1, ng2_img_cropper_1, googleplace_directive_1, ng2_file_upload_1, ng2_bootstrap_1, index_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
