        ...
        execute: function() {
            UserService = (function () {
                function UserService(http) {
                    ...
                    this.createCandidateUrl = appGlobals.apiUrl + '/user/create_candidate';
                 ...
                 * @returns {Observable<Response>}
                 */
                UserService.prototype.createUser = function (email, password, user_type_id) {
                    var requestBody = JSON.stringify({ email: email, password: password, user_type_id: user_type_id });
