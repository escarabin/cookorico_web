System.register(['@angular/core', '@angular/router', '../../services/reference.service.ts', '../../services/user.service.ts', '../../services/business.service.ts', '../../services/notification.service.ts', '../../models/business', '../../models/place', '../../models/notification', '../../../../../public/ng2-file-upload/ng2-file-upload.d'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, reference_service_ts_1, user_service_ts_1, business_service_ts_1, notification_service_ts_1, business_1, place_1, notification_1, ng2_file_upload_d_1;
    ...
    return {
        setters:[
            ...
            function (reference_service_ts_1_1) {
                reference_service_ts_1 = reference_service_ts_1_1;
            },
            function (user_service_ts_1_1) {
                user_service_ts_1 = user_service_ts_1_1;
            },
            function (business_service_ts_1_1) {
                business_service_ts_1 = business_service_ts_1_1;
            },
            function (notification_service_ts_1_1) {
                notification_service_ts_1 = notification_service_ts_1_1;
            },
            ...
            function (ng2_file_upload_d_1_1) {
                ng2_file_upload_d_1 = ng2_file_upload_d_1_1;
            }],
        execute: function() {
            CreateBusinessComponent = (function () {
                function CreateBusinessComponent(referenceService, userService, notificationService, businessService, ref, router, route) {
                    ...
                    this.photoUploader = new ng2_file_upload_d_1.FileUploader({ url: URL });
                ...
                CreateBusinessComponent = __decorate([
                    core_1.Component({
                        ...
                        providers: [reference_service_ts_1.ReferenceService,
                            user_service_ts_1.UserService,
                            business_service_ts_1.BusinessService],
                        templateUrl: '../templates/create-business.component.html'
                    }), 
                    __metadata('design:paramtypes', [reference_service_ts_1.ReferenceService, user_service_ts_1.UserService, notification_service_ts_1.NotificationsService, business_service_ts_1.BusinessService, core_1.ChangeDetectorRef, router_1.Router, router_1.ActivatedRoute])
