System.register(['@angular/core', '@angular/router-deprecated', './../services/job.service', './job-search-sidebar.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_deprecated_1, job_service_1, job_search_sidebar_component_1;
    var JobComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            JobComponent = (function () {
                ...
                JobComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [router_deprecated_1.RouterLink, job_search_sidebar_component_1.JobSearchSidebarComponent],
                        inputs: ['jobId'],
                        selector: 'job',
